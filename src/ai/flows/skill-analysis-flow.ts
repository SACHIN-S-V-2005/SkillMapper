...
const SkillAnalysisOutputSchema = z.object({
  ...
  recommendedResources: z.array(
    z.object({
      ...
      platform: z.string().describe('The platform offering the resource (e.g., Coursera, Udemy, Google Cloud Skills Boost).'),
...
4.  **Recommended Resources:**
    *   For each major missing skill or group of skills in the roadmap, recommend specific online courses, tutorials, or certifications from reputable platforms (e.g., Coursera, Udemy, Google Cloud Skills Boost, official documentation).
